            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        ...
                        border = borders_1[_i];
                        if (!(border.style !== border_style_1.BORDER_STYLE.NONE && !color_1.isTransparent(border.color))) return [3 /*break*/, 13];
                    ...
                    case 8:
                        ...
                        return [3 /*break*/, 12];
                    case 9:
                        if (!(border.style === border_style_1.BORDER_STYLE.SOLID)) return [3 /*break*/, 11];
